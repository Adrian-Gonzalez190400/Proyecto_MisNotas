...
import com.example.misnotas.adapters.RvTasksAdapter
...
class TaskFragment : Fragment(R.layout.fragment_nota) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        noteBinding.addNoteFab.setOnClickListener{
            ...
            navController.navigate(TaskFragmentDirections.actionTaskFragmentToSaveOrDeleteFragment())
        }
    ...
    private fun observerDataChanges() {
        noteActivityViewModel.getAllTasks().observe(viewLifecycleOwner){list ->
