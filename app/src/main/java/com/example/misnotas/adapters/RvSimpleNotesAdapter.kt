...
class RvSimpleNotesAdapter: ListAdapter<Note,RvSimpleNotesAdapter.NotesViewHolder>(DiffUtilCallbackNotes()) {
    ...
    inner class NotesViewHolder(itemView: View):RecyclerView.ViewHolder(itemView ){
        ...
        val tittle: MaterialTextView=contenBinding.noteItemTitle
        val content: TextView = contenBinding.noteContentItem
        val date: MaterialTextView=contenBinding.noteDate
        val parent: MaterialCardView=contenBinding.noteItemLayoutParent
